  ...
  return (
    <>
      <button
        ...
        className="px-3.5 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 hover:text-white text-xs font-bold border border-slate-700 flex items-center gap-1.5 transition active:scale-95"
      >
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fade-in">
          <div className="relative w-full max-w-md rounded-3xl bg-slate-900 border border-slate-800 shadow-2xl p-6 space-y-5 text-slate-100">
            {/* Header */}
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-bold text-white">Share Live Ride Tracking</h3>
                  <p className="text-xs text-slate-400">Allow family or friends to follow your commute live</p>
                </div>
              </div>
              <button
                type="button"
            ...
            {loading ? (
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 p-1.5 rounded-xl bg-slate-950 border border-slate-800">
                    <input
                      ...
                      className="flex-1 px-2.5 py-1 text-xs bg-transparent text-slate-200 border-none focus:outline-none truncate selection:bg-brand-500"
                    />
                    <button
                      type="button"
                      onClick={handleCopy}
                      className="px-3 py-1.5 rounded-lg bg-brand-500 hover:bg-brand-400 text-slate-950 font-bold text-xs flex items-center gap-1 transition active:scale-95"
                    >
                ...
                <div className="p-3.5 rounded-2xl bg-slate-950/70 border border-slate-800/80 space-y-2 text-xs">
                  ...
                  <div className="flex items-start gap-2 pt-1 border-t border-slate-800/60 text-[11px] text-emerald-400">
